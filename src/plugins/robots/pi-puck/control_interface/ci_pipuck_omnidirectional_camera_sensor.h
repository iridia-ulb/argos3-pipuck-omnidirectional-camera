#ifndef CCI_PIPUCK_OMNIDIRECTIONAL_CAMERA_SENSOR_H
#define CCI_PIPUCK_OMNIDIRECTIONAL_CAMERA_SENSOR_H

namespace argos {
   class CCI_PiPuckOmnidirectionalCameraSensor;
}
...
namespace argos {
   ...
   class CCI_PiPuckOmnidirectionalCameraSensor : public CCI_Sensor {
   ...
   public:
      ...
      CCI_PiPuckOmnidirectionalCameraSensor() {}

      virtual ~CCI_PiPuckOmnidirectionalCameraSensor() {}
